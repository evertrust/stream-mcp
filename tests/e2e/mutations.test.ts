...
/**
 * Opt-in mutation smoke against a live instance. The deterministic suites only exercise
 ...
 *
 * It writes to a SHARED test instance, so it is gated behind an explicit opt-in:
...
describe.skipIf(!enabled)(
  'mutation smoke (live instance, opt-in STREAM_E2E_MUTATE=1)',
  () => {
