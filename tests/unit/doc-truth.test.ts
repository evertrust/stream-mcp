 ...
 *
 * This suite guards the knowledge markdown the model reads first. It extracts
 * call-shaped examples (`tool_name(param=...)`) and bare backticked tool
 * mentions from src/resources/knowledge/*.md and asserts:
