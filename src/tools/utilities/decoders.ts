 ...
 * newlines / +/=). Each decoder uploads the object content under
 ...
 * uploaded bytes directly and does NOT base64-decode them (sending the base64
 * TEXT of a binary PKCS#12 fails with RFC5280-004 "Invalid PKCS#12"). Only strict base64 that decodes to an ASN.1 SEQUENCE
