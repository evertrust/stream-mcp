/**
 * System configuration entries (/api/v1/system/configuration routes).
 *
...
const licenseSchema = z.object({
  ...
  on_license_expiration: z
    ...
    .optional()
    .describe(
      'Names of pre-existing triggers fired on license expiration (triggers.onLicenseExpiration). Omit for no triggers.',
    ),
});
