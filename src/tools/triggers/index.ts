 ...
 * families in full; `external_rl_storage` shares the CRUD endpoints but is
 * not supported by these tools (list_triggers still surfaces them;
 * create/update/test reject them).
 *
 * Endpoints:
...
const KNOWLEDGE_REF = 'stream://knowledge/triggers';
  ...
  registerTool(
    ...
    'test_trigger',
    {
      description:
        ...
        'template bindings. (`external_rl_storage` triggers are not supported ' +
        'by these tools.)' +
        `\n\nRef: ${KNOWLEDGE_REF}.`,
