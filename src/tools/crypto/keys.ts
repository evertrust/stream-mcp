  ...
  registerTool(
    ...
    'create_key',
    {
      description:
        ...
        'algorithm is a key algorithm wire value (e.g. rsa-2048, ec-secp256r1, mldsa-44). ' +
      ...
      inputSchema: z.object({
        ...
        algorithm: z
          .enum(KEY_ALGORITHMS)
          .describe('Asymmetric algorithm (key algorithm wire value).'),
        extractable: z
          .boolean()
          .optional()
          .describe(
    ...
    async ({
      ...
      // `description` is the algorithm wire field.
      ...
      return text(
        buildMutateResponse({
          ...
          warnings:
            result === null
              ? [
                  'Key created on GCP but not yet readable; fetch later with get_key.',
                ]
              : undefined,
        }),
      );
