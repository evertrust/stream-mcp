...
const duration = z
  .string()
  .regex(DURATION_RE, 'Must be a duration like "3650 days".');
  ...
  registerTool(
    ...
    'generate_crl',
    {
      description:
        ...
        'forget). Returns no CRL — the server produces it in the background (HTTP 204). The CA ' +
